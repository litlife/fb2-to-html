...
EOT;
	...
	public function toHtml($s, $class_prefix = null): string
    {
		$dom = new DOMDocument();
...
EOT;
	...
	public function testStrikeThroughTag()
	{
		$xml = <<<EOT
<p>
...
EOT;
	...
	{
		$xml = <<<EOT
        <a href="https://example.comm" type="note">Ссылка</a>
EOT;
